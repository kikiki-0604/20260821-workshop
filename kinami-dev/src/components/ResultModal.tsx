      ...
      >
        ...
        <div className="flex flex-col gap-2 sm:flex-row">
          <button
            type="button"
            onClick={onRestart}
            className="flex-1 rounded-lg bg-emerald-600 px-4 py-2.5 font-semibold text-white shadow transition hover:bg-emerald-700 active:scale-95"
          >
            もう一度対局する
          </button>
          <button
            ...
            className="flex-1 rounded-lg bg-slate-200 px-4 py-2.5 font-semibold text-slate-700 shadow transition hover:bg-slate-300 active:scale-95 dark:bg-slate-700 dark:text-slate-100 dark:hover:bg-slate-600"
          >
            モード選択に戻る
          </button>
        </div>
